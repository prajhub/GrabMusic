...
export default function Hero() {
  return (
    <div className="mx-auto bg-[#ec4b60] max-w-full px-4 sm:px-6 lg:px-8 pt-20 pb-16 text-center lg:pt-10">
      <p className="mx-auto -mt-4 max-w-1xl text-lg tracking-tight text-white sm:mt-6">
        Welcome to
      ...
      <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
        ...
        <span className="inline-block text-white">App Store</span>
      </h1>
